...
public partial class GenVMegaMazasEnsambleView : UserControl
{
    public GenVMegaMazasEnsambleView()
    {
        InitializeComponent();
        DataContext = new GenVMegaMazasEnsambleViewModel();
        var tabControl = this.FindControl<TabControl>("MainTabControl");
        tabControl!.Items.Add(DcpControlCreator.CreateTabItem(StaticFields.isPared ? "Mazas PTN-134" : "Mazas PTN-126", 
            StaticFields.isPared ? "Gen V Mega | Mazas PTN-134 Pared" : "Gen V Mega | Mazas PTN-126 Pasillo",
            RecordNumber.First,
            DcpControlCreator.CreateGrid(mazasDcps, "First", "Gage\nG-6387-XX")));
        tabControl!.Items.Add(DcpControlCreator.CreateTabItem(StaticFields.isPared ? "Mazas PTN-135" : "Mazas PTN-127", 
            StaticFields.isPared ? "Gen V Mega | Mazas PTN-135 Pared" : "Gen V Mega | Mazas PTN-127 Pasillo",
            RecordNumber.Second,
            DcpControlCreator.CreateGrid(mazasDcps, "Second", "Gage\nG-6387-XX")));
        tabControl!.Items.Add(DcpControlCreator.CreateTabItem(StaticFields.isPared ? "Ensamble PPE-038" : "Ensamble PPE-042", 
            StaticFields.isPared ? "Gen V Mega | Ensamble PPE-038" : "Gen V Mega | Ensamble PPE-042",
            RecordNumber.Third,
    ...
    private List<Dcp> mazasDcps = new List<Dcp>()
    {
        ...
        new Dcp(code: "Dcp172", inputPerTurn: 1, start: true, mid: true, end: true)
        {
            ...
            Gage = StaticFields.isPared ? "02" : "01",
            Sample = "1",
            InspectFrequency = "Cada 10 piezas",
            IsCheckBox = false,
        },
    ...
    private List<Dcp> ensambleDcps = new List<Dcp>()
    {
        new Dcp(code: "Dcp76", inputPerTurn: 1, start: true, mid: true, end: true)
        {
            ...
            Gage = "Visual\nNota: Piezas dudosas usar gage 25",
            Sample = "1",
            InspectFrequency = "100 %",
            IsCheckBox = true,
        },
