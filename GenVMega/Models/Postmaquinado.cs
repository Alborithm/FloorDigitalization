...
public partial class Postmaquinado : ObservableValidator
{
    ...
    [ObservableProperty]
    [NotifyDataErrorInfo]
    [Range(0.00, 0.25, ErrorMessage = "Valor fuera de especificación ({1} a {2})")]
    ...
    [ObservableProperty]
    [NotifyDataErrorInfo]
    [Range(37.60, 37.625, ErrorMessage = "Valor fuera de especificación ({1} a {2})")]
    ...
    // ----------- DCP 15 ----------- (-0.065 to 0.065)
    [ObservableProperty]
    [NotifyDataErrorInfo]
    [Range(-0.065, 0.065, ErrorMessage = "Valor fuera de especificación ({1} a {2})")]
    ...
    [ObservableProperty]
    [NotifyDataErrorInfo]
    [Range(1.25, 2.50, ErrorMessage = "Valor fuera de especificación ({1} a {2})")]
    ...
    [ObservableProperty]
    [NotifyDataErrorInfo]
    [Range(0.00, 0.125, ErrorMessage = "Valor fuera de especificación ({1} a {2})")]
    ...
    [ObservableProperty]
    [NotifyDataErrorInfo]
    [Range(0.00, 2.00, ErrorMessage = "Valor fuera de especificación ({1} a {2})")]
    private decimal? _dcp20ipStart;

    // ----------- DCP 22 ----------- (0 to 0.05)
    [ObservableProperty]
    [NotifyDataErrorInfo]
    [Range(0.00, 0.05, ErrorMessage = "Valor fuera de especificación ({1} a {2})")]
    ...
    [ObservableProperty]
    [NotifyDataErrorInfo]
    [Range(0.00, 0.6, ErrorMessage = "Valor fuera de especificación ({1} a {2})")]
