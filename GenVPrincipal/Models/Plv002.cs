...
public partial class Plv002 : ObservableValidator
{
    // ----------- Concentracion ----------- 
    [ObservableProperty]
    [NotifyDataErrorInfo]
    ...
    [ObservableProperty]
    [NotifyDataErrorInfo]
    [Range(9, 9999, ErrorMessage = "Valor fuera de especificación (mayor o igual a {1})")]
    ...
    [ObservableProperty]
    [NotifyDataErrorInfo]
    [Range(50, 60, ErrorMessage = "Valor fuera de especificación ({1} a {2})")]
    ...
    [ObservableProperty]
    [NotifyDataErrorInfo]
    [Range(10, 30, ErrorMessage = "Valor fuera de especificación ({1} a {2})")]
    ...
    [ObservableProperty]
    [NotifyDataErrorInfo]
    [Range(9, 9999, ErrorMessage = "Valor fuera de especificación (mayor o igual a {2})")]
